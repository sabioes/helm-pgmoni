...
echo "==== Installation of Hello-world"
kubectl create namespace ${APPNAMESPACE}
cat app/helloworld/template-hello-world-values.yaml | envsubst | helm install helloworld ./app/helloworld/hello-world -n ${APPNAMESPACE} --values - 

#helm install hello-world ./app/hello-world-helm/hello-world -n ${APPNAMESPACE} 
